...
- Public-facing branding is "Sora Creator Tools." The manifest and in-app copy reflect this.
...
- App Store validation enforces Safari's manifest limits (name ≤ 40 chars, description ≤ 112). If submitting to App Store, use shorter manifest strings.
