...
- App Store validation enforces Safari’s manifest limits (name ≤ 40 chars, description ≤ 112). `manifest.json` now uses `name: "Sora Creator Tools"` and a concise description to satisfy both Chrome and Safari packaging.
